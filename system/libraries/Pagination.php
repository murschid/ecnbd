...
class CI_Pagination {
     ...
     * @var	string
     */
    protected $data_page_attr = 'data-ci-pagination-page class="page-link"';
            ...
            for ($loop = $start - 1; $loop <= $end; $loop++) {
                ...
                if ($i >= $base_page) {
                    if ($this->cur_page === $loop) {
                        // Current page
                        $output .= $this->cur_tag_open . converter::times($loop) . $this->cur_tag_close;
                    } elseif ($i === $base_page) {
                        // First page
                        $output .= $this->num_tag_open . '<a href="' . $first_url . '"' . $attributes . $this->_attr_rel('start') . '>' . converter::times($loop) . '</a>' . $this->num_tag_close;
                    } else {
                        $append = $this->prefix . $i . $this->suffix;
                        $output .= $this->num_tag_open . '<a href="' . $base_url . $append . '"' . $attributes . '>' . converter::times($loop) . '</a>' . $this->num_tag_close;
                    }
                }
            }
        }
